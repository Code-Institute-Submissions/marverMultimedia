...
AWS_ACCESS_KEY_ID = os.getenv('AWS_ACCESS_KEY_ID','AKIAIBJCJA2RWV4CLKEQ')
AWS_SECRET_ACCESS_KEY = os.getenv('AWS_SECRET_ACCESS_KEY','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')
