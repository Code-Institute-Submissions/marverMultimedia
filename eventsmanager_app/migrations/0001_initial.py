# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-10-22 08:19
...
import eventsmanager_app.models
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', eventsmanager_app.models.AccountUserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Agenda',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('webcast_image', models.ImageField(blank=True, default='marverhigres.png', upload_to=eventsmanager_app.models.webcast_image_path, verbose_name='Upload Main Image')),
            ],
        ),
        migrations.CreateModel(
            name='Webcast',
            fields=[
                ...
                ('webcast_img', models.ImageField(blank=True, default='marverhigres.png', upload_to=eventsmanager_app.models.webcast_image_path, verbose_name='Upload Main Image')),
                ...
                ('customer_id', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='eventsmanager_app.Customers')),
                ('speaker_id', models.ManyToManyField(blank=True, to='eventsmanager_app.Speakers', verbose_name='Speakers Creation/Selection ')),
                ('webcast_asset_ID', models.ManyToManyField(blank=True, to='eventsmanager_app.Assets', verbose_name='Select Assets')),
            ],
        ),
        migrations.AddField(
            model_name='thumbnails',
            name='webcast_id',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='eventsmanager_app.Webcast'),
        ),
        migrations.AddField(
            model_name='agenda',
            name='webcast_id',
