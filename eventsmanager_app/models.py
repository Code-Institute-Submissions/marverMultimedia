...
class Speakers(models.Model):
        ...
        speaker_pic_url = models.ImageField(upload_to='speakers', default=None,
...
class Webcast(models.Model):
    ...
    webcast_status = models.CharField(max_length=30, default=None, choices=(('OD', 'ON-DEMAND'), ('LIVE', 'LIVE')),
                                      verbose_name='Webcast Type')
    ...
    webcast_img = models.ImageField(upload_to='media/', default='House-of-Commons.png',
                                    verbose_name='Upload Main Image', blank=True)
